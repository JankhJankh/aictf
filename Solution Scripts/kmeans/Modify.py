    ...
    if filename.startswith("auto"):
      ...
      for i in range(0,32):
        ...
        for j in range(0,32):
          ...
          image[i][j][0] = val
    #Save the modified image
    scipy.misc.toimage(image, cmin=0.0, cmax=255).save("kmeansModToPass\\"+filename)
